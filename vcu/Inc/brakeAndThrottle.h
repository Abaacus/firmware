...
#define THROTT_A_LOW (2590)
#define THROTT_B_LOW (1108)

#define THROTT_A_HIGH (2924)
#define THROTT_B_HIGH (1436)

#define BRAKE_POS_LOW (1020)
#define BRAKE_POS_HIGH (1114)
...
#define THROTTLE_POLLING_PERIOD_MS 20
