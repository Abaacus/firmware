...
#define TPS_TOLERANCE_PERCENT 0x000AU
#define TPS_MAX_WHILE_BRAKE_PRESSED_PERCENT 25
#define TPS_WHILE_BRAKE_PRESSED_RESET_PERCENT 5

#define THROTT_A_LOW (0x0000072BU)
#define THROTT_B_LOW (0x0000023AU)

#define THROTT_A_HIGH (0x0000085EU)
#define THROTT_B_HIGH (0x00000393U)
...
#define MAX_THROTTLE_A_DEADZONE (0x000000C8U)
#define MAX_THROTTLE_B_DEADZONE (0x000000C8U)
...
#define BRAKE_PRESSURE_DIVIDER 0x00000FFFU
#define BRAKE_PRESSURE_MULTIPLIER 0x00000064U
