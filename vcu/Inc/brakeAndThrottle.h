...
#define TPS_TOLERANCE_PERCENT UINT32_C(10)
#define TPS_MAX_WHILE_BRAKE_PRESSED_PERCENT 25
#define TPS_WHILE_BRAKE_PRESSED_RESET_PERCENT 5

#define THROTT_A_LOW UINT32_C(1835)
#define THROTT_B_LOW UINT32_C(570)

#define THROTT_A_HIGH UINT32_C(2142)
#define THROTT_B_HIGH UINT32_C(915)
...
#define MAX_THROTTLE_A_DEADZONE UINT32_C(200)
#define MAX_THROTTLE_B_DEADZONE UINT32_C(200)
...
#define TPS_MULTPLIER 100.0
#define TPS_DIVISOR 4095.0
#define TPS_MAX 4095

#define BRAKE_POSITION_DIVIDER 4095
#define BRAKE_POSITION_MULTIPLIER 100

#define BRAKE_PRESSURE_DIVIDER UINT32_C(4095)
#define BRAKE_PRESSURE_MULTIPLIER UINT32_C(100)
