...
#include "cmsis_os.h"
static BaseType_t sensorsCommand(char *writeBuffer, size_t writeBufferLength, const char *commandString);

static BaseType_t sensorsCommand(char *writeBuffer, size_t writeBufferLength,
