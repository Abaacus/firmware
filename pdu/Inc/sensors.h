...
#define FAN_FUSE_RATING_AMPS 10.0f
#define PUMP_FUSE_RATING_AMPS 10.0f
#define MC_FUSE_RATING_AMPS 3.0f
#define DCU_FUSE_RATING_AMPS 3.0f
#define VCU_FUSE_RATING_AMPS 2.0f
#define BMU_FUSE_RATING_AMPS 5.0f
#define WSB_FUSE_RATING_AMPS 2.0f
#define AUX_FUSE_RATING_AMPS 2.0f
#define BRAKE_LIGHT_FUSE_RATING_AMPS 2.0f
#define LV_FUSE_RATING_AMPS 20.0f
