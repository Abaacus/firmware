...
#define FAN_FUSE_RATING_AMPS 10.0
#define PUMP_FUSE_RATING_AMPS 10.0
#define MC_FUSE_RATING_AMPS 3.0
#define DCU_FUSE_RATING_AMPS 3.0
#define VCU_FUSE_RATING_AMPS 2.0
#define BMU_FUSE_RATING_AMPS 5.0
#define WSB_FUSE_RATING_AMPS 2.0
#define AUX_FUSE_RATING_AMPS 2.0
#define BRAKE_LIGHT_FUSE_RATING_AMPS 2.0
#define LV_FUSE_RATING_AMPS 20.0
