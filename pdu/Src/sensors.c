...
const char *channelNames[] = {  "Fan Right",
                            ...
                            "BMU",
                            "WSB"};
const float fuseRatings[] = { FAN_FUSE_RATING_AMPS,
                            DCU_FUSE_RATING_AMPS,
                            MC_FUSE_RATING_AMPS,
                            PUMP_FUSE_RATING_AMPS,
                            FAN_FUSE_RATING_AMPS,
                            VCU_FUSE_RATING_AMPS,
                            BRAKE_LIGHT_FUSE_RATING_AMPS,
                            AUX_FUSE_RATING_AMPS,
                            LV_FUSE_RATING_AMPS,
                            LV_FUSE_RATING_AMPS,
                            MC_FUSE_RATING_AMPS,
                            PUMP_FUSE_RATING_AMPS,
                            BMU_FUSE_RATING_AMPS,
                            WSB_FUSE_RATING_AMPS
};
