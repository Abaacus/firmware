...
int WfeDashboard::run (
    ...
    while (true) {
        ...
        switch (frame.can_id)
        {
            ...
            // VCU_EnduranceMode_Debug
            case 2282032130:
            {
                // Endurance_Laps_Completed
                // Start bit: 0, length: 8, unsigned
                // Factor: 1, offset: 0
                data->laps_completed = frame.data[0];
            }

            // Read DTC messages
            // WSBRL_DTC, WSBRR_DTC, WSBFR_DTC, WSBFL_DTC,
            // PDU_DTC, DCU_DTC, VCU_F7_DTC, BMU_DTC, ChargeCart_DTC
            case 2147548939:
            case 2147548938:
            case 2147548937:
            case 2147548936:
